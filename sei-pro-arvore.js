...
(function(){
  ...
  function injectFallbackStyles() {
    ...
    var css = [
      ...
      "#sei-pro-upload-form .dz-preview .dz-progress{grid-column:2;grid-row:2;height:6px;border-radius:999px;background:#dce4ff;overflow:hidden;width:100%;position:relative;z-index:10;}",
      "#sei-pro-upload-form .dz-preview .dz-progress .dz-upload{background:linear-gradient(90deg,#4da2ff 0%,#0d6efd 100%);height:100%;position:relative;z-index:11;border-radius:999px;transition:width .3s ease;}",
