# Script para Gerar CRX da Extensão SEI Smart
# Este script usa o Chrome para gerar um arquivo CRX assinado

Write-Host "=====================================" -ForegroundColor Cyan
Write-Host "   SEI Smart - Gerador de CRX" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    if (Test-Path $crxFile) {
        ...
        Move-Item *crx $newCrxPath -Force
